    ...
    'typesense' => [
        ...
        'model-settings' => [
            ...
            Product::class => [
                'collection-schema' => [
                    'fields' => [
                        ['name' => 'name_ar', 'type' => 'string', 'locale' => 'ar', 'sort' => true],
                        ['name' => 'name_en', 'type' => 'string', 'locale' => 'en', 'sort' => true],

                        ['name' => 'description_ar', 'type' => 'string', 'locale' => 'ar'],
                        ['name' => 'description_en', 'type' => 'string', 'locale' => 'en'],

                        ['name' => 'category_ar', 'type' => 'string', 'locale' => 'ar'],
                        ['name' => 'category_en', 'type' => 'string', 'locale' => 'en'],
