<x-layout title="Contact">
    <div class="max-w-7xl mx-auto py-8 px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600">We'd love to hear from you. Send us a message and we'll respond as soon as
                possible.</p>
        </div>
            ...
            <div>
                <div class="card bg-base-100 border border-base-300">
                    <div class="card-body">
                        ...
                        <form id="js-contact-form" x-target
                              action="{{ route('contact.store', ['language' => app()->getLocale()]) }}" method="post">
                            @csrf
                            <fieldset class="fieldset">
                                <label class="label">Name</label>
                                <input type="text" name="name" class="input w-full validator" placeholder="Your name"
                                       required
                                       value="{{ old('name', auth()->user()->name ?? '') }}"/>

                                <label class="label mt-4">Email</label>
                                <input type="email" name="email" class="input w-full validator"
                                       placeholder="your@email.com" required
                                       value="{{ old('email', auth()->user()->email ?? '') }}"/>

                                <label class="label mt-4">Message</label>
                                <textarea name="message" class="textarea h-32 w-full validator"
            ...
            <div class="space-y-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <div class="tooltip" data-tip="Open location in Google Maps">
                                <a href="https://www.google.com/maps/place/123+Perfume+Street,+Fragrance+City,+FC+12345"
                                   target="_blank" rel="noopener noreferrer" class="link link-hover">123 Perfume
                                    Street<br>Fragrance City, FC 12345</a>
                            </div>
                        </div>
                ...
                <div class="card bg-primary text-primary-content">
                    <div class="card-body">
                        ...
                        <p class="mb-4 text-sm opacity-90">Our customer support team is available during business
                            hours.</p>
